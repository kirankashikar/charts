  ...
  return (
    <div style={{ padding: "24px 28px 40px" }}>
      ...
      <p style={{ fontSize: 13, color: "#605d5d", margin: "4px 0 20px", maxWidth: "60ch" }}>
        Types are grouped by the question they answer. Picking one seeds the next step with data shaped the way it
        draws.
      </p>
            ...
            {group.items.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontSize: 11, color: "#7d7979", marginTop: 3, lineHeight: 1.35 }}>{item.note}</div>
                </button>
              );
            })}
          </div>
